...
const Edit = () => {
    ...
    const updateForm =async(e)=>{
        e.preventDefault();
        await axios.put(`https://pawan-data-base.onrender.com/api/user/update/${id}`,user).then((Response)=>{
    ...
    useEffect(()=>{
        axios.get(`https://pawan-data-base.onrender.com/api/user/fetchById/${id}`).then((response)=>{
